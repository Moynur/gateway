...
func TestService_Refund(t *testing.T) {
	t.Run("Should fail refund due to Pan", func(t *testing.T) {
		...
		assert.Error(t, err)
		assert.Equal(t, models.ErrCantRefund, err)
	})

	t.Run("Should Fail Refund as amount is too large", func(t *testing.T) {
		id := uuid.MustParse("123e4567-e89b-12d3-a456-426655440000")
		id2 := uuid.MustParse("123e4567-0000-12d3-0000-426655440000")
